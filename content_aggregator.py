...
def home():
    ...
    web application
    Returns: display of the web appication
    '''
    #make HTTP requests to recieve raw HTML content from websites
    ...
    soup = BeautifulSoup(source, 'lxml')
    wash_list = []
    for div in soup.find_all('div', class_ = 'left wrap-text art-size--md'):
        try: 
            headline = div.h2.a.text
            wash_list.append(headline)
        except:
            pass
    wash1 = wash_list[0]
    wash2 = wash_list[1]
    ...
    return '''
        <html>
            ...
            <body style='background-color:#87CEFA'>
                ...
                <h2>
                    <span  style="font-size: 22px; color: red; font-family: Arial">The Washington Post Front Page</span>
                    <span style="font-size: 10px; color: orange"><a href="https://www.washingtonpost.com">(https://www.washingtonpost.com)</a></span>
                </h2>
                <ul style='font-family: Arial'>
                    <li>{wash1}</li>
                    <li>{wash2}</li>
